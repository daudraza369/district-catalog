...
export function OriginBadge({ origin }: { origin: Origin }) {
  ...
  return (
    <div className="flex items-center justify-center">
      {hasFile ? (
        <Image src={`/origins/${origin}.svg`} alt={ORIGIN_LABELS[origin]} width={56} height={56} className="opacity-80" />
      ) : (
        <svg viewBox="0 0 24 24" fill="none" width="56" height="56" opacity="0.4">
